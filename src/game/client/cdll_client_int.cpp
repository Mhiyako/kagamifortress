...
// Discord RPC
static ConVar cl_discord_appid("cl_discord_appid", "732432618360144002", FCVAR_DEVELOPMENTONLY | FCVAR_CHEAT);
...
int CHLClient::Init( CreateInterfaceFn appSystemFactory, CreateInterfaceFn physicsFactory, CGlobalVarsBase *pGlobals )
{
	...
	if (!g_bTextMode)
	{
		...
		discordPresence.largeImageKey = "troll_face_shadow_large";
