...
const char *g_aWeaponNames[] =
{
	...
	"TF_WEAPON_DISPENSER",
	"TF_WEAPON_INVIS",
	//New weapons go under 'ere
	"TF_WEAPON_ATOMIZER",
	"TF_WEAPON_ATOMLAUNCHER",			// 11-14-20
	"TF_WEAPON_FISH",					// 11-15-20
...
int g_aWeaponDamageTypes[] =
{
	...
	DMG_CLUB,		// TF_WEAPON_ATOMIZER
	DMG_BLAST | DMG_HALF_FALLOFF | DMG_USEDISTANCEMOD,		// TF_WEAPON_ATOMLAUNCHER,
	DMG_CLUB,		// TF_WEAPON_FISH,
