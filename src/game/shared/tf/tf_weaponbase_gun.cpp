...
CBaseEntity *CTFWeaponBaseGun::FireProjectile( CTFPlayer *pPlayer )
{
	...
	case TF_PROJECTILE_SYRINGE:
		pProjectile = FireSyringe( pPlayer, iProjectile );
		pPlayer->DoAnimationEvent( PLAYERANIMEVENT_ATTACK_PRIMARY );
		break;
...
//-----------------------------------------------------------------------------
// Purpose: Fire a projectile SYRINGE
//-----------------------------------------------------------------------------
CBaseEntity *CTFWeaponBaseGun::FireSyringe(CTFPlayer *pPlayer, int iSpecificSyringe)
{
	PlayWeaponShootSound();
