...
#define TF_WEAPON_ATOMROCKET_INTERVAL					0.8f

#define TF_WEAPON_FLAMETHROWER_INTERVAL					0.15f
#define TF_WEAPON_FLAMETHROWER_ROCKET_INTERVAL			0.8f
#define TF_WEAPON_FLAMETHROWER_ATOMROCKET_INTERVAL		0.8f
...
enum
{
	...
	TF_WEAPON_FLAMETHROWER_ATOMROCKET,
	TF_WEAPON_GRENADE_DEMOMAN,
	TF_WEAPON_SENTRY_BULLET,
	TF_WEAPON_SENTRY_ROCKET,
	TF_WEAPON_DISPENSER,
	TF_WEAPON_INVIS,
	//New additions go under 'ere
	TF_WEAPON_ATOMIZER,
	TF_WEAPON_ATOMLAUNCHER,
	TF_WEAPON_FISH,
...
enum
{
	...
	HINT_CANNOT_TAUNT_WHILE_CLOAKED,	// #Hint_Cannot_Taunt_While_Cloaked
